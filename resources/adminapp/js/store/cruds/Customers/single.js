function initialState() {
  return {
    entry: {
      ...
      commune_of_birth_id: null,
      village_of_birth_id: null,
...
const actions = {
  ...
  setCountryOfBirth({ commit }, value) {
    commit('setCountryOfBirth', value)
  },
  setProvinceOfBirth({ commit }, value) {
    commit('setProvinceOfBirth', value)
  },
  setDistrictOfBirth({ commit }, value) {
    commit('setDistrictOfBirth', value)
  },
  setCommuneOfBirth({ commit }, value) {
    commit('setCommuneOfBirth', value)
  },
  setVillageOfBirth({ commit }, value) {
    commit('setVillageOfBirth', value)
  },
  ...
  setLengthOfService({ commit }, value) {
    commit('setLengthOfService', value)
  },
  setCompanyCurrency({ commit }, value) {
    commit('setCompanyCurrency', value)
  },
  setTotalMonthlyIncome({ commit }, value) {
    commit('setTotalMonthlyIncome', value)
  },
  setTotalRentExpense({ commit }, value) {
    commit('setTotalRentExpense', value)
  },
  setTotalInsuranceExpense({ commit }, value) {
    commit('setTotalInsuranceExpense', value)
  },
  setTotalMonthlyLoanPayment({ commit }, value) {
    commit('setTotalMonthlyLoanPayment', value)
  },
  setTotalOtherExpense({ commit }, value) {
    commit('setTotalOtherExpense', value)
  },
  setZeeCashBalance({ commit }, value) {
    commit('setZeeCashBalance', value)
  },
...
const mutations = {
  ...
  setCountryOfBirth(state, value) {
    state.entry.country_of_birth_id = value
  },
  setProvinceOfBirth(state, value) {
    state.entry.province_of_birth_id = value
  },
  setDistrictOfBirth(state, value) {
    state.entry.district_of_birth_id = value
  },
  setCommuneOfBirth(state, value) {
    state.entry.commune_of_birth_id = value
  },
  setVillageOfBirth(state, value) {
    state.entry.village_of_birth_id = value
  },
  ...
  setFamilyIdType(state, value) {
    state.entry.family_id_type_id = value
  },
  ...
  setCompanyCountry(state, value) {
    state.entry.company_country_id = value
  },
  setCompanyProvince(state, value) {
    state.entry.company_province_id = value
  },
  setCompanyDistrict(state, value) {
    state.entry.company_district_id = value
  },
  setCompanyCommune(state, value) {
    state.entry.company_commune_id = value
  },
  setCompanyVillage(state, value) {
    state.entry.company_village_id = value
  },
  ...
  setLengthOfService(state, value) {
    state.entry.length_of_service = value
  },
  setCompanyCurrency(state, value) {
    state.entry.company_currency_id = value
  },
  setTotalMonthlyIncome(state, value) {
    state.entry.total_monthly_income = value
  },
  setTotalRentExpense(state, value) {
    state.entry.total_rent_expense = value
  },
  setTotalInsuranceExpense(state, value) {
    state.entry.total_insurance_expense = value
  },
  setTotalMonthlyLoanPayment(state, value) {
    state.entry.total_monthly_loan_payment = value
  },
  setTotalOtherExpense(state, value) {
    state.entry.total_other_expense = value
  },
  setZeeCashBalance(state, value) {
    state.entry.zee_cash_balance = value
  },
