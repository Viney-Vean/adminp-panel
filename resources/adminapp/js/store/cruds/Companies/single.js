...
const actions = {
  ...
  setContactPersonEmail({ commit }, value) {
    commit('setContactPersonEmail', value)
  },
  setRegistrationNumber({ commit }, value) {
    commit('setRegistrationNumber', value)
  },
  setTaxRegime({ commit }, value) {
    commit('setTaxRegime', value)
  },
  setVat({ commit }, value) {
    commit('setVat', value)
  },
...
const mutations = {
  ...
  setContactPersonEmail(state, value) {
    state.entry.contact_person_email = value
  },
  setRegistrationNumber(state, value) {
    state.entry.registration_number = value
  },
  setTaxRegime(state, value) {
    state.entry.tax_regime = value
  },
  setVat(state, value) {
    state.entry.vat = value
  },
