...
export default {
  ...
  computed: {
    ...mapGetters('WriteOffsSingle', ['entry'])
  },
  watch: {
    '$route.params.id': {
      immediate: true,
  ...
  methods: {
    ...mapActions('WriteOffsSingle', ['fetchShowData', 'resetState'])
  }
}
</script>
