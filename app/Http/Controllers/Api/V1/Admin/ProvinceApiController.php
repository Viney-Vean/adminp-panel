...
class ProvinceApiController extends Controller
{
    public function index()
    {
        ...
        return new ProvinceResource(Province::with(['branch', 'country'])->advancedFilter());
    }
    ...
    public function create(Province $province)
    {
        ...
        return response([
            'meta' => [
                ...
                'country' => Country::get(['id', 'name_en']),
            ],
        ]);
    }
    ...
    public function show(Province $province)
    {
        ...
        return new ProvinceResource($province->load(['branch', 'country']));
    }
    ...
    public function edit(Province $province)
    {
        ...
        return response([
            'data' => new ProvinceResource($province->load(['branch', 'country'])),
            'meta' => [
                'branch'  => Branch::get(['id', 'name_en']),
                'country' => Country::get(['id', 'name_en']),
            ],
