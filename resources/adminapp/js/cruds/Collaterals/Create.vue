            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.collateral.fields.collateral')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.collateral_type,
                  ...
                  >
                    ...
                    <input
                      ...
                      @focus="focusField('collateral_type')"
                      @blur="clearFocus"
                    />
                  </div>
                  <div
...
export default {
  ...
  methods: {
    ...
    updateCollateralType(e) {
      this.setCollateralType(e.target.value)
    },
    updateCurrency(e) {
    ...
    updateCommune(e) {
      this.setCommune(e.target.value)
    },
    updateVillage(e) {
