        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary card-header-icon">
              ...
              <h4 class="card-title">
                {{ $t('global.create') }}
                <strong>{{ $t('cruds.village.title_singular') }}</strong>
              </h4>
            </div>
            <div class="card-body">
                ...
                <div class="col-md-12">
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.village.fields.commune')
                    }}</label>
                    <v-select
                      name="commune"
                      label="name_en"
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.village.fields.name_en')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.village.fields.name_lc')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
...
export default {
  ...
  computed: {
    ...mapGetters('VillagesSingle', ['entry', 'loading', 'lists'])
  },
  mounted() {
