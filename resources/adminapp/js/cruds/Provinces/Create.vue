        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary card-header-icon">
              ...
              <h4 class="card-title">
                {{ $t('global.create') }}
                <strong>{{ $t('cruds.province.title_singular') }}</strong>
              </h4>
            </div>
            <div class="card-body">
                ...
                <div class="col-md-12">
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.province.fields.branch')
                    }}</label>
                    <v-select
                      name="branch"
                      label="name_en"
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.province.fields.country')
                    }}</label>
                    <v-select
                      name="country"
                      label="name_en"
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.province.fields.name_en')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.province.fields.name_lc')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
...
export default {
  ...
  computed: {
    ...mapGetters('ProvincesSingle', ['entry', 'loading', 'lists'])
  },
  mounted() {
  ...
  methods: {
    ...
    submitForm() {
      this.storeData()
        .then(() => {
          this.$router.push({ name: 'provinces.index' })
