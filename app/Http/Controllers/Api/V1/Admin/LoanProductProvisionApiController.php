...
class LoanProductProvisionApiController extends Controller
{
    public function index()
    {
        ...
        return new LoanProductProvisionResource(LoanProductProvision::with(['branch', 'product', 'class', 'outstandingCoa', 'airCoa', 'intIncomeCoa', 'interestInSuspendCoa', 'provisionExpenseCoa', 'provisionReserveCoa', 'penaltyCoa', 'incomeChargeCoa', 'inSuspendChargeCoa', 'chargeReceivableCoa'])->advancedFilter());
    }
    ...
    public function create(LoanProductProvision $loanProductProvision)
    {
        ...
        return response([
            'meta' => [
                ...
                'int_income_coa'              => ChartOfAccount::get(['id', 'account_title']),
                ...
                'income_charge_coa'           => ChartOfAccount::get(['id', 'account_title']),
                'in_suspend_charge_coa'       => ChartOfAccount::get(['id', 'account_title']),
                'charge_receivable_coa'       => ChartOfAccount::get(['id', 'account_title']),
                'more_than_one_year'          => LoanProductProvision::MORE_THAN_ONE_YEAR_SELECT,
                'interest_income_recognition' => LoanProductProvision::INTEREST_INCOME_RECOGNITION_SELECT,
            ],
        ]);
    }
    ...
    public function show(LoanProductProvision $loanProductProvision)
    {
        ...
        return new LoanProductProvisionResource($loanProductProvision->load(['branch', 'product', 'class', 'outstandingCoa', 'airCoa', 'intIncomeCoa', 'interestInSuspendCoa', 'provisionExpenseCoa', 'provisionReserveCoa', 'penaltyCoa', 'incomeChargeCoa', 'inSuspendChargeCoa', 'chargeReceivableCoa']));
    }
    ...
    public function edit(LoanProductProvision $loanProductProvision)
    {
        ...
        return response([
            'data' => new LoanProductProvisionResource($loanProductProvision->load(['branch', 'product', 'class', 'outstandingCoa', 'airCoa', 'intIncomeCoa', 'interestInSuspendCoa', 'provisionExpenseCoa', 'provisionReserveCoa', 'penaltyCoa', 'incomeChargeCoa', 'inSuspendChargeCoa', 'chargeReceivableCoa'])),
            'meta' => [
                'branch'                      => Branch::get(['id', 'branch']),
                'product'                     => LoanProduct::get(['id', 'description']),
                'class'                       => Provision::get(['id', 'class_title']),
