...
class ApplicationApiController extends Controller
{
    public function index()
    {
        ...
        return new ApplicationResource(Application::with(['branch', 'currency', 'loanProduct'])->advancedFilter());
    }
    ...
    public function show(Application $application)
    {
        ...
        return new ApplicationResource($application->load(['branch', 'currency', 'loanProduct']));
    }
    ...
    public function edit(Application $application)
    {
        ...
        return response([
            'data' => new ApplicationResource($application->load(['branch', 'currency', 'loanProduct'])),
            'meta' => [
                'branch'              => Branch::get(['id', 'branch']),
                'currency'            => Currency::get(['id', 'description']),
                'loan_product'        => LoanProduct::get(['id', 'description']),
