...
class CompanyApiController extends Controller
{
    public function index()
    {
        ...
        return new CompanyResource(Company::with(['branch'])->advancedFilter());
    }
    ...
    public function create(Company $company)
    {
        ...
        return response([
            'meta' => [
                ...
                'tax_regime' => Company::TAX_REGIME_SELECT,
            ],
        ]);
    }
    ...
    public function show(Company $company)
    {
        ...
        return new CompanyResource($company->load(['branch']));
    }
    ...
    public function edit(Company $company)
    {
        ...
        return response([
            'data' => new CompanyResource($company->load(['branch'])),
            'meta' => [
                'branch'     => Branch::get(['id', 'name_en']),
                'tax_regime' => Company::TAX_REGIME_SELECT,
            ],
