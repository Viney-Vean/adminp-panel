        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary card-header-icon">
              ...
              <h4 class="card-title">
                {{ $t('global.edit') }}
                <strong>{{ $t('cruds.district.title_singular') }}</strong>
              </h4>
            </div>
            <div class="card-body">
                ...
                <div class="col-md-12">
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.district.fields.branch')
                    }}</label>
                    <v-select
                      name="branch"
                      label="name_en"
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.district.fields.province')
                    }}</label>
                    <v-select
                      name="province"
                      label="name_en"
                  ...
                  >
                    <label class="bmd-label-floating required">{{
                      $t('cruds.district.fields.name_en')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.district.fields.name_lc')
                    }}</label>
                    <input
                      class="form-control"
                      type="text"
...
export default {
  ...
  computed: {
    ...mapGetters('DistrictsSingle', ['entry', 'loading', 'lists'])
  },
  beforeDestroy() {
    this.resetState()
  },
  ...
  methods: {
    ...
    submitForm() {
      this.updateData()
        .then(() => {
          this.$router.push({ name: 'districts.index' })
