                  ...
                  <div class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <datatable-enum :row="entry" field="frequency">
                          </datatable-enum>
                        </td>
                      </tr>
                      <tr>
...
export default {
  ...
  computed: {
    ...mapGetters('ApplicationsSingle', ['entry'])
  },
  watch: {
    '$route.params.id': {
      immediate: true,
  ...
  methods: {
    ...mapActions('ApplicationsSingle', ['fetchShowData', 'resetState'])
  }
}
</script>
