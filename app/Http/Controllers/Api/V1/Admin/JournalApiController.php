...
class JournalApiController extends Controller
{
    public function index()
    {
        ...
        return new JournalResource(Journal::with(['branch', 'account', 'currency', 'class'])->advancedFilter());
    }
    ...
    public function show(Journal $journal)
    {
        ...
        return new JournalResource($journal->load(['branch', 'account', 'currency', 'class']));
    }
}
