...
class PastDueDetailApiController extends Controller
{
    public function index()
    {
        ...
        return new PastDueDetailResource(PastDueDetail::with(['branch', 'schedule', 'contract'])->advancedFilter());
    }
    ...
    public function show(PastDueDetail $pastDueDetail)
    {
        ...
        return new PastDueDetailResource($pastDueDetail->load(['branch', 'schedule', 'contract']));
    }
    ...
    public function edit(PastDueDetail $pastDueDetail)
    {
        ...
        return response([
            'data' => new PastDueDetailResource($pastDueDetail->load(['branch', 'schedule', 'contract'])),
            'meta' => [
                'branch'   => Branch::get(['id', 'name_en']),
                'schedule' => Schedule::get(['id', 'no']),
                'contract' => Contract::get(['id', 'code']),
