...
class AccountEntryApiController extends Controller
{
    public function index()
    {
        ...
        return new AccountEntryResource(AccountEntry::with(['branch', 'account', 'chartOfAccount', 'currency'])->advancedFilter());
    }
    ...
    public function show(AccountEntry $accountEntry)
    {
        ...
        return new AccountEntryResource($accountEntry->load(['branch', 'account', 'chartOfAccount', 'currency']));
    }
}
