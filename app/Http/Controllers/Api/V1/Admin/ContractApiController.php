...
class ContractApiController extends Controller
{
    public function index()
    {
        ...
        return new ContractResource(Contract::with(['branch', 'customer', 'application', 'ddAccount', 'currency', 'loanProduct', 'provisionClass', 'officer'])->advancedFilter());
    }
    ...
    public function create(Contract $contract)
    {
        ...
        return response([
            'meta' => [
                ...
                'application'         => Application::get(['id', 'code']),
    ...
    public function show(Contract $contract)
    {
        ...
        return new ContractResource($contract->load(['branch', 'customer', 'application', 'ddAccount', 'currency', 'loanProduct', 'provisionClass', 'officer']));
    }
    ...
    public function edit(Contract $contract)
    {
        ...
        return response([
            'data' => new ContractResource($contract->load(['branch', 'customer', 'application', 'ddAccount', 'currency', 'loanProduct', 'provisionClass', 'officer'])),
            'meta' => [
                'branch'              => Branch::get(['id', 'name_en']),
                'customer'            => Customer::get(['id', 'customer_name']),
                'application'         => Application::get(['id', 'code']),
