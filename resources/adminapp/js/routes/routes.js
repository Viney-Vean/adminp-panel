      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () => import('@cruds/Nationalities/Index.vue'),
            meta: { title: 'cruds.nationality.title' }
          },
          {
            path: 'nationalities/create',
            name: 'nationalities.create',
            component: () => import('@cruds/Nationalities/Create.vue'),
            meta: { title: 'cruds.nationality.title' }
          },
          {
            path: 'nationalities/:id',
            name: 'nationalities.show',
            component: () => import('@cruds/Nationalities/Show.vue'),
            meta: { title: 'cruds.nationality.title' }
          },
          {
            path: 'nationalities/:id/edit',
            name: 'nationalities.edit',
            component: () => import('@cruds/Nationalities/Edit.vue'),
            meta: { title: 'cruds.nationality.title' }
          },
          {
            path: 'countries',
          ...
          },
          {
            ...
            component: () => import('@cruds/Provinces/Index.vue'),
            meta: { title: 'cruds.province.title' }
          },
          {
            path: 'provinces/create',
            name: 'provinces.create',
            component: () => import('@cruds/Provinces/Create.vue'),
            meta: { title: 'cruds.province.title' }
          },
          {
            path: 'provinces/:id',
            name: 'provinces.show',
            component: () => import('@cruds/Provinces/Show.vue'),
            meta: { title: 'cruds.province.title' }
          },
          {
            path: 'provinces/:id/edit',
            name: 'provinces.edit',
            component: () => import('@cruds/Provinces/Edit.vue'),
            meta: { title: 'cruds.province.title' }
          },
          {
            path: 'districts',
            name: 'districts.index',
            component: () => import('@cruds/Districts/Index.vue'),
            meta: { title: 'cruds.district.title' }
          },
          {
            path: 'districts/create',
            name: 'districts.create',
            component: () => import('@cruds/Districts/Create.vue'),
            meta: { title: 'cruds.district.title' }
          },
          {
            path: 'districts/:id',
            name: 'districts.show',
            component: () => import('@cruds/Districts/Show.vue'),
            meta: { title: 'cruds.district.title' }
          },
          {
            path: 'districts/:id/edit',
            name: 'districts.edit',
            component: () => import('@cruds/Districts/Edit.vue'),
            meta: { title: 'cruds.district.title' }
          },
          {
            path: 'communes',
            name: 'communes.index',
            component: () => import('@cruds/Communes/Index.vue'),
            meta: { title: 'cruds.commune.title' }
          },
          {
            path: 'communes/create',
            name: 'communes.create',
            component: () => import('@cruds/Communes/Create.vue'),
            meta: { title: 'cruds.commune.title' }
          },
          {
            path: 'communes/:id',
            name: 'communes.show',
            component: () => import('@cruds/Communes/Show.vue'),
            meta: { title: 'cruds.commune.title' }
          },
          {
            path: 'communes/:id/edit',
            name: 'communes.edit',
            component: () => import('@cruds/Communes/Edit.vue'),
            meta: { title: 'cruds.commune.title' }
          },
          {
            path: 'villages',
            name: 'villages.index',
            component: () => import('@cruds/Villages/Index.vue'),
            meta: { title: 'cruds.village.title' }
          },
          {
            path: 'villages/create',
            name: 'villages.create',
            component: () => import('@cruds/Villages/Create.vue'),
            meta: { title: 'cruds.village.title' }
          },
          {
            path: 'villages/:id',
            name: 'villages.show',
            component: () => import('@cruds/Villages/Show.vue'),
            meta: { title: 'cruds.village.title' }
          },
          {
            path: 'villages/:id/edit',
            name: 'villages.edit',
            component: () => import('@cruds/Villages/Edit.vue'),
            meta: { title: 'cruds.village.title' }
          }
        ]
      },
