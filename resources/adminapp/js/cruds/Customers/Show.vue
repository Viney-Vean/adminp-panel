                  ...
                  <div class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <datatable-single :row="entry" field="branch.name_en">
                          </datatable-single>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <datatable-enum :row="entry" field="title">
                          </datatable-enum>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <datatable-single :row="entry" field="gender.label">
                          </datatable-single>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <datatable-single :row="entry" field="officer.label">
                          </datatable-single>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="text-primary">
                          {{
                            $t(
                              'cruds.customer.fields.total_monthly_loan_payment'
                            )
                          }}
                        </td>
                        <td>
                          {{ entry.total_monthly_loan_payment }}
                        </td>
                      </tr>
                      <tr>
                        <td class="text-primary">
                      ...
                      <tr>
                        ...
                        <td>
                          <datatable-enum :row="entry" field="block">
                          </datatable-enum>
                        </td>
                      </tr>
                      <tr>
