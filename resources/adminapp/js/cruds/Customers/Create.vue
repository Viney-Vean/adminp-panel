              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.country_of_birth_id !== null,
                      'is-focused': activeField == 'country_of_birth'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.country_of_birth')
                    }}</label>
                    <v-select
                      name="country_of_birth"
                      label="name_en"
                      :key="'country_of_birth-field'"
                      :value="entry.country_of_birth_id"
                      :options="lists.country_of_birth"
                      :reduce="entry => entry.id"
                      @input="updateCountryOfBirth"
                      @search.focus="focusField('country_of_birth')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.province_of_birth_id !== null,
                      'is-focused': activeField == 'province_of_birth'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.province_of_birth')
                    }}</label>
                    <v-select
                      name="province_of_birth"
                      label="name_en"
                      :key="'province_of_birth-field'"
                      :value="entry.province_of_birth_id"
                      :options="lists.province_of_birth"
                      :reduce="entry => entry.id"
                      @input="updateProvinceOfBirth"
                      @search.focus="focusField('province_of_birth')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.district_of_birth_id !== null,
                      'is-focused': activeField == 'district_of_birth'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.district_of_birth')
                    }}</label>
                    <v-select
                      name="district_of_birth"
                      label="name_en"
                      :key="'district_of_birth-field'"
                      :value="entry.district_of_birth_id"
                      :options="lists.district_of_birth"
                      :reduce="entry => entry.id"
                      @input="updateDistrictOfBirth"
                      @search.focus="focusField('district_of_birth')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.commune_of_birth_id !== null,
                      'is-focused': activeField == 'commune_of_birth'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.commune_of_birth')
                    }}</label>
                    <v-select
                      name="commune_of_birth"
                      label="name_en"
                      :key="'commune_of_birth-field'"
                      :value="entry.commune_of_birth_id"
                      :options="lists.commune_of_birth"
                      :reduce="entry => entry.id"
                      @input="updateCommuneOfBirth"
                      @search.focus="focusField('commune_of_birth')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.village_of_birth_id !== null,
                      'is-focused': activeField == 'village_of_birth'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.village_of_birth')
                    }}</label>
                    <v-select
                      name="village_of_birth"
                      label="name_en"
                      :key="'village_of_birth-field'"
                      :value="entry.village_of_birth_id"
                      :options="lists.village_of_birth"
                      :reduce="entry => entry.id"
                      @input="updateVillageOfBirth"
                      @search.focus="focusField('village_of_birth')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.province')
                    }}</label>
                    <v-select
                      name="province"
                      label="name_en"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.district')
                    }}</label>
                    <v-select
                      name="district"
                      label="name_en"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.commune')
                    }}</label>
                    <v-select
                      name="commune"
                      label="name_en"
                  ...
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.village')
                    }}</label>
                    <v-select
                      name="village"
                      label="name_en"
                  ...
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.family_id_type_id !== null,
                  ...
                  >
                    ...
                    <v-select
                      name="family_id_type"
                      label="label"
                      :key="'family_id_type-field'"
                      :value="entry.family_id_type_id"
                      :options="lists.family_id_type"
                      :reduce="entry => entry.id"
                      @input="updateFamilyIdType"
                      @search.focus="focusField('family_id_type')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                  ...
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.company_country_id !== null,
                  ...
                  >
                    ...
                    <v-select
                      ...
                      label="name_en"
                      :key="'company_country-field'"
                      :value="entry.company_country_id"
                      :options="lists.company_country"
                      :reduce="entry => entry.id"
                      @input="updateCompanyCountry"
                      @search.focus="focusField('company_country')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.company_province_id !== null,
                  ...
                  >
                    ...
                    <v-select
                      ...
                      label="name_en"
                      :key="'company_province-field'"
                      :value="entry.company_province_id"
                      :options="lists.company_province"
                      :reduce="entry => entry.id"
                      @input="updateCompanyProvince"
                      @search.focus="focusField('company_province')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.company_district_id !== null,
                  ...
                  >
                    ...
                    <v-select
                      ...
                      label="name_en"
                      :key="'company_district-field'"
                      :value="entry.company_district_id"
                      :options="lists.company_district"
                      :reduce="entry => entry.id"
                      @input="updateCompanyDistrict"
                      @search.focus="focusField('company_district')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.company_commune_id !== null,
                  ...
                  >
                    ...
                    <v-select
                      ...
                      label="name_en"
                      :key="'company_commune-field'"
                      :value="entry.company_commune_id"
                      :options="lists.company_commune"
                      :reduce="entry => entry.id"
                      @input="updateCompanyCommune"
                      @search.focus="focusField('company_commune')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.company_village_id !== null,
                  ...
                  >
                    ...
                    <v-select
                      ...
                      label="name_en"
                      :key="'company_village-field'"
                      :value="entry.company_village_id"
                      :options="lists.company_village"
                      :reduce="entry => entry.id"
                      @input="updateCompanyVillage"
                      @search.focus="focusField('company_village')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                  ...
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.length_of_service,
                      'is-focused': activeField == 'length_of_service'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.length_of_service')
                    }}</label>
                    <input
                      class="form-control"
                      type="number"
                      step="1"
                      :value="entry.length_of_service"
                      @input="updateLengthOfService"
                      @focus="focusField('length_of_service')"
                      @blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.company_currency_id !== null,
                      'is-focused': activeField == 'company_currency'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.company_currency')
                    }}</label>
                    <v-select
                      name="company_currency"
                      label="description"
                      :key="'company_currency-field'"
                      :value="entry.company_currency_id"
                      :options="lists.company_currency"
                      :reduce="entry => entry.id"
                      @input="updateCompanyCurrency"
                      @search.focus="focusField('company_currency')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.total_monthly_income,
                      'is-focused': activeField == 'total_monthly_income'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.total_monthly_income')
                    }}</label>
                    <input
                      class="form-control"
                      type="number"
                      step="0.01"
                      :value="entry.total_monthly_income"
                      @input="updateTotalMonthlyIncome"
                      @focus="focusField('total_monthly_income')"
                      @blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.total_rent_expense,
                      'is-focused': activeField == 'total_rent_expense'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.total_rent_expense')
                    }}</label>
                    <input
                      class="form-control"
                      type="number"
                      step="0.01"
                      :value="entry.total_rent_expense"
                      @input="updateTotalRentExpense"
                      @focus="focusField('total_rent_expense')"
                      @blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.total_insurance_expense,
                      'is-focused': activeField == 'total_insurance_expense'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.total_insurance_expense')
                    }}</label>
                    <input
                      class="form-control"
                      type="number"
                      step="0.01"
                      :value="entry.total_insurance_expense"
                      @input="updateTotalInsuranceExpense"
                      @focus="focusField('total_insurance_expense')"
                      @blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.total_monthly_loan_payment,
                      'is-focused': activeField == 'total_monthly_loan_payment'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.total_monthly_loan_payment')
                    }}</label>
                    <input
                      class="form-control"
                      type="number"
                      step="0.01"
                      :value="entry.total_monthly_loan_payment"
                      @input="updateTotalMonthlyLoanPayment"
                      @focus="focusField('total_monthly_loan_payment')"
                      @blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.total_other_expense,
                      'is-focused': activeField == 'total_other_expense'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.total_other_expense')
                    }}</label>
                    <input
                      class="form-control"
                      type="number"
                      step="0.01"
                      :value="entry.total_other_expense"
                      @input="updateTotalOtherExpense"
                      @focus="focusField('total_other_expense')"
                      @blur="clearFocus"
                    />
                  </div>
                  <div
                    class="form-group bmd-form-group"
                    :class="{
                      'has-items': entry.zee_cash_balance,
                      'is-focused': activeField == 'zee_cash_balance'
                    }"
                  >
                    <label class="bmd-label-floating">{{
                      $t('cruds.customer.fields.zee_cash_balance')
                    }}</label>
                    <input
                      class="form-control"
                      type="number"
                      step="0.01"
                      :value="entry.zee_cash_balance"
                      @input="updateZeeCashBalance"
                      @focus="focusField('zee_cash_balance')"
                      @blur="clearFocus"
                    />
                  </div>
                  <div
                  ...
                  >
                    ...
                    <v-select
                      ...
                      :reduce="entry => entry.value"
                      @input="updateBlock"
                      @search.focus="focusField('block')"
                      @search.blur="clearFocus"
                    />
                  </div>
                  <div class="form-group">
                    <label>{{
                      $t('cruds.customer.fields.block_reason')
                    }}</label>
                    <ckeditor
                      :editor="editor"
...
export default {
  ...
  methods: {
    ...mapActions('CustomersSingle', [
      ...
      'setTotalRentExpense',
      'setTotalInsuranceExpense',
      'setTotalMonthlyLoanPayment',
      'setTotalOtherExpense',
      'setZeeCashBalance',
      'setBlock',
      'setBlockReason',
      'fetchCreateData'
    ...
    updateCountryOfBirth(value) {
      this.setCountryOfBirth(value)
    },
    updateProvinceOfBirth(value) {
      this.setProvinceOfBirth(value)
    },
    updateDistrictOfBirth(value) {
      this.setDistrictOfBirth(value)
    },
    updateCommuneOfBirth(value) {
      this.setCommuneOfBirth(value)
    },
    updateVillageOfBirth(value) {
      this.setVillageOfBirth(value)
    },
    ...
    updateFamilyIdType(value) {
      this.setFamilyIdType(value)
    },
    ...
    updateCompanyCountry(value) {
      this.setCompanyCountry(value)
    },
    updateCompanyProvince(value) {
      this.setCompanyProvince(value)
    },
    updateCompanyDistrict(value) {
      this.setCompanyDistrict(value)
    },
    updateCompanyCommune(value) {
      this.setCompanyCommune(value)
    },
    updateCompanyVillage(value) {
      this.setCompanyVillage(value)
    },
    ...
    updateLengthOfService(e) {
      this.setLengthOfService(e.target.value)
    },
    updateCompanyCurrency(value) {
      this.setCompanyCurrency(value)
    },
    updateTotalMonthlyIncome(e) {
      this.setTotalMonthlyIncome(e.target.value)
    },
    updateTotalRentExpense(e) {
      this.setTotalRentExpense(e.target.value)
    },
    updateTotalInsuranceExpense(e) {
      this.setTotalInsuranceExpense(e.target.value)
    },
    updateTotalMonthlyLoanPayment(e) {
      this.setTotalMonthlyLoanPayment(e.target.value)
    },
    updateTotalOtherExpense(e) {
      this.setTotalOtherExpense(e.target.value)
    },
    updateZeeCashBalance(e) {
      this.setZeeCashBalance(e.target.value)
    },
    updateBlock(value) {
      this.setBlock(value)
    },
