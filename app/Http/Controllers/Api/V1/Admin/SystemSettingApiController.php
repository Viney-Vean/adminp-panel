...
class SystemSettingApiController extends Controller
{
    public function index()
    {
        ...
        return new SystemSettingResource(SystemSetting::with(['branch'])->advancedFilter());
    }
    ...
    public function show(SystemSetting $systemSetting)
    {
        ...
        return new SystemSettingResource($systemSetting->load(['branch']));
    }
    ...
    public function edit(SystemSetting $systemSetting)
    {
        ...
        return response([
            'data' => new SystemSettingResource($systemSetting->load(['branch'])),
            'meta' => [
                'branch' => Branch::get(['id', 'branch_manager_en']),
            ],
        ]);
