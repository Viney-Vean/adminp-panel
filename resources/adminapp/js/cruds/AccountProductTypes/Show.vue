                    ...
                    <tbody>
                      <tr>
                        <td class="text-primary">
                          {{ $t('cruds.accountProductType.fields.id') }}
                        </td>
                        <td>
                          {{ entry.id }}
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <datatable-enum :row="entry" field="account_type">
                          </datatable-enum>
                        </td>
                      </tr>
                    </tbody>
...
export default {
  ...
  computed: {
    ...mapGetters('AccountProductTypesSingle', ['entry'])
  },
  watch: {
    '$route.params.id': {
      immediate: true,
  ...
  methods: {
    ...mapActions('AccountProductTypesSingle', ['fetchShowData', 'resetState'])
  }
}
</script>
